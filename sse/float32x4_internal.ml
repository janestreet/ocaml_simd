...
external add : t -> t -> t = "ocaml_simd_unreachable" "caml_sse_float32x4_add"
[@@noalloc] [@@unboxed] [@@builtin]

external sub : t -> t -> t = "ocaml_simd_unreachable" "caml_sse_float32x4_sub"
[@@noalloc] [@@unboxed] [@@builtin]

external mul : t -> t -> t = "ocaml_simd_unreachable" "caml_sse_float32x4_mul"
[@@noalloc] [@@unboxed] [@@builtin]

external div : t -> t -> t = "ocaml_simd_unreachable" "caml_sse_float32x4_div"
[@@noalloc] [@@unboxed] [@@builtin]

external max : t -> t -> t = "ocaml_simd_unreachable" "caml_sse_float32x4_max"
[@@noalloc] [@@unboxed] [@@builtin]

external min : t -> t -> t = "ocaml_simd_unreachable" "caml_sse_float32x4_min"
[@@noalloc] [@@unboxed] [@@builtin]

external rcp : t -> t = "ocaml_simd_unreachable" "caml_sse_float32x4_rcp"
[@@noalloc] [@@unboxed] [@@builtin]

external rsqrt : t -> t = "ocaml_simd_unreachable" "caml_sse_float32x4_rsqrt"
[@@noalloc] [@@unboxed] [@@builtin]

external sqrt : t -> t = "ocaml_simd_unreachable" "caml_sse_float32x4_sqrt"
[@@noalloc] [@@unboxed] [@@builtin]
...
external addsub : t -> t -> t = "ocaml_simd_unreachable" "caml_sse3_float32x4_addsub"
[@@noalloc] [@@unboxed] [@@builtin]
