...
external add
  ...
  -> t
  @@ portable
  = "ocaml_simd_unreachable" "caml_sse2_float64x2_add"
[@@noalloc] [@@unboxed] [@@builtin]
...
external sub
  ...
  -> t
  @@ portable
  = "ocaml_simd_unreachable" "caml_sse2_float64x2_sub"
[@@noalloc] [@@unboxed] [@@builtin]
...
external mul
  ...
  -> t
  @@ portable
  = "ocaml_simd_unreachable" "caml_sse2_float64x2_mul"
[@@noalloc] [@@unboxed] [@@builtin]
...
external div
  ...
  -> t
  @@ portable
  = "ocaml_simd_unreachable" "caml_sse2_float64x2_div"
[@@noalloc] [@@unboxed] [@@builtin]
...
external max
  ...
  -> t
  @@ portable
  = "ocaml_simd_unreachable" "caml_sse2_float64x2_max"
[@@noalloc] [@@unboxed] [@@builtin]
...
external min
  ...
  -> t
  @@ portable
  = "ocaml_simd_unreachable" "caml_sse2_float64x2_min"
[@@noalloc] [@@unboxed] [@@builtin]

external sqrt : t -> t @@ portable = "ocaml_simd_unreachable" "caml_sse2_float64x2_sqrt"
[@@noalloc] [@@unboxed] [@@builtin]
...
external addsub
  ...
  -> t
  @@ portable
  = "ocaml_simd_unreachable" "caml_sse3_float64x2_addsub"
[@@noalloc] [@@unboxed] [@@builtin]
...
external dup_low_64
  ...
  -> t
  @@ portable
  = "ocaml_simd_unreachable" "caml_sse3_vec128_dup_low_64"
[@@noalloc] [@@unboxed] [@@builtin]
