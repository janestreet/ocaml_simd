...
external add : t -> t -> t = "ocaml_simd_unreachable" "caml_sse2_int16x8_add"
[@@noalloc] [@@unboxed] [@@builtin]
...
external sub : t -> t -> t = "ocaml_simd_unreachable" "caml_sse2_int16x8_sub"
[@@noalloc] [@@unboxed] [@@builtin]
...
external max : t -> t -> t = "ocaml_simd_unreachable" "caml_sse2_int16x8_max"
[@@noalloc] [@@unboxed] [@@builtin]

external min : t -> t -> t = "ocaml_simd_unreachable" "caml_sse2_int16x8_min"
[@@noalloc] [@@unboxed] [@@builtin]
...
external cmpeq : t -> t -> t = "ocaml_simd_unreachable" "caml_sse2_int16x8_cmpeq"
[@@noalloc] [@@unboxed] [@@builtin]

external cmpgt : t -> t -> t = "ocaml_simd_unreachable" "caml_sse2_int16x8_cmpgt"
[@@noalloc] [@@unboxed] [@@builtin]

external abs : t -> t = "ocaml_simd_unreachable" "caml_ssse3_int16x8_abs"
[@@noalloc] [@@unboxed] [@@builtin]

external horizontal_add : t -> t -> t = "ocaml_simd_unreachable" "caml_ssse3_int16x8_hadd"
[@@noalloc] [@@unboxed] [@@builtin]

external sll : t -> int64x2# -> t = "ocaml_simd_unreachable" "caml_sse2_int16x8_sll"
[@@noalloc] [@@unboxed] [@@builtin]

external srl : t -> int64x2# -> t = "ocaml_simd_unreachable" "caml_sse2_int16x8_srl"
[@@noalloc] [@@unboxed] [@@builtin]

external sra : t -> int64x2# -> t = "ocaml_simd_unreachable" "caml_sse2_int16x8_sra"
[@@noalloc] [@@unboxed] [@@builtin]
...
external horizontal_sub : t -> t -> t = "ocaml_simd_unreachable" "caml_ssse3_int16x8_hsub"
[@@noalloc] [@@unboxed] [@@builtin]
...
external mulsign : t -> t -> t = "ocaml_simd_unreachable" "caml_ssse3_int16x8_mulsign"
[@@noalloc] [@@unboxed] [@@builtin]
...
external mul_high : t -> t -> t = "ocaml_simd_unreachable" "caml_sse2_int16x8_mul_high"
[@@noalloc] [@@unboxed] [@@builtin]

external mul_low : t -> t -> t = "ocaml_simd_unreachable" "caml_sse2_int16x8_mul_low"
[@@noalloc] [@@unboxed] [@@builtin]
...
external shuffle_8 : t -> t -> t = "ocaml_simd_unreachable" "caml_ssse3_vec128_shuffle_8"
[@@noalloc] [@@unboxed] [@@builtin]
