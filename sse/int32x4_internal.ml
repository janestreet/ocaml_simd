...
external add : t -> t -> t = "ocaml_simd_unreachable" "caml_sse2_int32x4_add"
[@@noalloc] [@@unboxed] [@@builtin]

external sub : t -> t -> t = "ocaml_simd_unreachable" "caml_sse2_int32x4_sub"
[@@noalloc] [@@unboxed] [@@builtin]

external cmpeq : t -> t -> t = "ocaml_simd_unreachable" "caml_sse2_int32x4_cmpeq"
[@@noalloc] [@@unboxed] [@@builtin]

external cmpgt : t -> t -> t = "ocaml_simd_unreachable" "caml_sse2_int32x4_cmpgt"
[@@noalloc] [@@unboxed] [@@builtin]

external sll : t -> int64x2# -> t = "ocaml_simd_unreachable" "caml_sse2_int32x4_sll"
[@@noalloc] [@@unboxed] [@@builtin]

external srl : t -> int64x2# -> t = "ocaml_simd_unreachable" "caml_sse2_int32x4_srl"
[@@noalloc] [@@unboxed] [@@builtin]

external sra : t -> int64x2# -> t = "ocaml_simd_unreachable" "caml_sse2_int32x4_sra"
[@@noalloc] [@@unboxed] [@@builtin]

external abs : t -> t = "ocaml_simd_unreachable" "caml_ssse3_int32x4_abs"
[@@noalloc] [@@unboxed] [@@builtin]

external horizontal_add : t -> t -> t = "ocaml_simd_unreachable" "caml_ssse3_int32x4_hadd"
[@@noalloc] [@@unboxed] [@@builtin]

external horizontal_sub : t -> t -> t = "ocaml_simd_unreachable" "caml_ssse3_int32x4_hsub"
[@@noalloc] [@@unboxed] [@@builtin]

external mulsign : t -> t -> t = "ocaml_simd_unreachable" "caml_ssse3_int32x4_mulsign"
[@@noalloc] [@@unboxed] [@@builtin]

external max : t -> t -> t = "ocaml_simd_unreachable" "caml_sse41_int32x4_max"
[@@noalloc] [@@unboxed] [@@builtin]
...
external min : t -> t -> t = "ocaml_simd_unreachable" "caml_sse41_int32x4_min"
[@@noalloc] [@@unboxed] [@@builtin]
...
external mul_low : t -> t -> t = "ocaml_simd_unreachable" "caml_sse41_int32x4_mul_low"
[@@noalloc] [@@unboxed] [@@builtin]
...
external dup_odd_32 : t -> t = "ocaml_simd_unreachable" "caml_sse3_vec128_dup_odd_32"
[@@noalloc] [@@unboxed] [@@builtin]

external dup_even_32 : t -> t = "ocaml_simd_unreachable" "caml_sse3_vec128_dup_even_32"
[@@noalloc] [@@unboxed] [@@builtin]
