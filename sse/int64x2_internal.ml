...
external sub : t -> t -> t @@ portable = "ocaml_simd_unreachable" "caml_sse2_int64x2_sub"
[@@noalloc] [@@unboxed] [@@builtin]
...
external cmpeq
  ...
  -> t
  @@ portable
  = "ocaml_simd_unreachable" "caml_sse41_int64x2_cmpeq"
[@@noalloc] [@@unboxed] [@@builtin]
...
external cmpgt
  ...
  -> t
  @@ portable
  = "ocaml_simd_unreachable" "caml_sse42_int64x2_cmpgt"
[@@noalloc] [@@unboxed] [@@builtin]
...
external sll
  ...
  -> t
  @@ portable
  = "ocaml_simd_unreachable" "caml_sse2_int64x2_sll"
[@@noalloc] [@@unboxed] [@@builtin]
...
external srl
  ...
  -> t
  @@ portable
  = "ocaml_simd_unreachable" "caml_sse2_int64x2_srl"
[@@noalloc] [@@unboxed] [@@builtin]
