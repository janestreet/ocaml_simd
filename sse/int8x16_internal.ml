...
external add : t -> t -> t = "ocaml_simd_unreachable" "caml_sse2_int8x16_add"
[@@noalloc] [@@unboxed] [@@builtin]
...
external sub : t -> t -> t = "ocaml_simd_unreachable" "caml_sse2_int8x16_sub"
[@@noalloc] [@@unboxed] [@@builtin]
...
external max : t -> t -> t = "ocaml_simd_unreachable" "caml_sse41_int8x16_max"
[@@noalloc] [@@unboxed] [@@builtin]

external min : t -> t -> t = "ocaml_simd_unreachable" "caml_sse41_int8x16_min"
[@@noalloc] [@@unboxed] [@@builtin]
...
external cmpeq : t -> t -> t = "ocaml_simd_unreachable" "caml_sse2_int8x16_cmpeq"
[@@noalloc] [@@unboxed] [@@builtin]

external cmpgt : t -> t -> t = "ocaml_simd_unreachable" "caml_sse2_int8x16_cmpgt"
[@@noalloc] [@@unboxed] [@@builtin]
...
external abs : t -> t = "ocaml_simd_unreachable" "caml_ssse3_int8x16_abs"
[@@noalloc] [@@unboxed] [@@builtin]

external mulsign : t -> t -> t = "ocaml_simd_unreachable" "caml_ssse3_int8x16_mulsign"
[@@noalloc] [@@unboxed] [@@builtin]
